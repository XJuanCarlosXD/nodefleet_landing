          ...
          <div className="contenCard">
            <div className="Content-Card">
              ...
              <div className="Cards">
                ...
                <div className="SubtexCard">
                  Monthly subscription service to generate your nodes and
                  visualize the quality of your service.
                </div>
                <a
            ...
            <div className="Content-Card">
              ...
              <div className="Cards">
                ...
                <div className="SubtexCard">
                  Staking dashboard for our customers, where they can: Stake a
                  node, check rewards, node performance.
                </div>
                <a
                  href="https://nodefleet.org/"
                  target="_blank"
                  className="ButtonLink"
                >
                  Learn More
