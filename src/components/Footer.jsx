  ...
  return (
    <div className="content-footer" id="contact">
      <div className="TextFppter">
        <span>Companies that have trusted us</span>
      </div>
      <div className="CardEFo">
        <img src="/images/footerIcon.png" alt="" />
      </div>
      <div className="content-icones">
        <span className="button-lest">Let’s Connect!</span>
        <a href="https://t.me/nodefleet" target="_blank" className="image">
      ...
      <div className="FooterTexty">
        <p>@ 2023. All rights reserved by Nodefleet</p>
        <p>Privacy Policy</p>
      </div>
    </div>
  );
